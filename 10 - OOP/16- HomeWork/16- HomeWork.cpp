...
public:
    ...
    void setMainProgramming(string Programming)
    {
        _MainProgrammingLanguage = Programming;
    }
...
int main()
{
    clsDeveloper D1(10, "Mohammed", "Abu-Hadhoud", "A@a.com", "8298982", "CEO", "ProgrammingAdvices", 5000 , "C++");
