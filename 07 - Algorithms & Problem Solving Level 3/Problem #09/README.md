...
A C++ solution for analyzing and solving the problem of **Print Middle Row & Middle Column**.

---

## 📋 Problem Description

Generate a 3x3 random matrix, then print the middle row and the middle column.
...
1. Open the project solution file (`Problem #09.slnx` or `.vcxproj`) in Visual Studio.
2. Compile and run the `Problem #09.cpp` file.
