...
A C++ solution for analyzing and solving the problem of **Store Column Sums in a Separate Array**.

---

## 📋 Problem Description

Generate a 3x3 random matrix, calculate the sum of each column, store results in a separate array, and print them.
...
1. Open the project solution file (`Problem #05.slnx` or `.vcxproj`) in Visual Studio.
2. Compile and run the `Problem #05.cpp` file.
