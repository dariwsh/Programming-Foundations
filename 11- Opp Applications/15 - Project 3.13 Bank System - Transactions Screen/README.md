# 💳 Bank System — Lesson 13: Transactions Subsystem (`clsTransactionsScreen`)

> **Milestone:** Project 3: Bank System — Lesson #13 (UI - Transactions Menu)  
...
Dedicated sub-menu screen coordinating financial transaction operations: Deposits, Withdrawals, and Total Balances.

---

## 🎯 Key Concepts & Implementation Highlights

- Sub-menu navigation architecture (`enTransactionsMenueOptions`)
- Encapsulating financial workflows behind a unified interface
- Return to main menu coordination

---

## 🗂️ Key Files & Architecture

- **Primary Classes / Headers:** `clsScreen.h`, `clsTransactionsScreen.h`, `clsDepositScreen.h`, `clsWithdrawScreen.h`, `clsTotalBalancesScreen.h`
