# 👥 Bank System — Lesson 21: Delete User Screen (`clsDeleteUserScreen`)

> **Milestone:** Project 3: Bank System — Lesson #21 (Delete User Screen)  
...
Deletes users with critical security guardrails preventing the deletion of the built-in `Admin` superuser.

---

## 🎯 Key Concepts & Implementation Highlights

- `clsDeleteUserScreen` implementation
- System Protection Guardrail: preventing deletion of the `Admin` account
- Confirmation prompt and clean state reset

---

## 🗂️ Key Files & Architecture

- **Primary Classes / Headers:** `clsScreen.h`, `clsDeleteUserScreen.h`, `clsUser.h`
