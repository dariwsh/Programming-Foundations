# 💳 Bank System — Lesson 15: Withdraw Screen (`clsWithdrawScreen`)

> **Milestone:** Project 3: Bank System — Lesson #15 (UI - Withdraw Screen)  
...
Financial transaction UI screen allowing debiting accounts with strict overdraft and balance validation.

---

## 🎯 Key Concepts & Implementation Highlights

- `clsBankClient::Withdraw(Amount)` domain method with sufficiency check
- Validation preventing withdrawals exceeding available balance
- Confirmation prompt before final execution

---

## 🗂️ Key Files & Architecture

- **Primary Classes / Headers:** `clsScreen.h`, `clsWithdrawScreen.h`, `clsBankClient.h`, `clsInputValidate.h`
