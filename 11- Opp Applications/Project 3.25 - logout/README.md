# 🔐 Bank System — Lesson 25: Logout Mechanism

> **Milestone:** Project 3: Bank System — Lesson #25 (Logout)  
...
Implements clean session termination by clearing the global user context and triggering the exit flow.

---

## 🎯 Key Concepts & Implementation Highlights

- Session Termination (`CurrentUser = clsUser::Find("", "")`)
- Returning control from the main screen loop
...
- **Primary Classes / Headers:** `clsMainScreen.h`, `Global.h`, `clsUser.h`
