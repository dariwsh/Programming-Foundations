# 🖥️ Bank System — Lesson 10: Delete Client Screen (`clsDeleteClientScreen`)

> **Milestone:** Project 3: Bank System — Lesson #10 (UI - Delete Client Screen)  
...
Dedicated UI screen to search for a client, display a detailed profile preview, and confirm safe deletion.

---

## 🎯 Key Concepts & Implementation Highlights

- `clsDeleteClientScreen` workflow and client card rendering
- Safety confirmation prompts (`Y/N`) before destructive action
- Detailed feedback upon success or cancellation

---

## 🗂️ Key Files & Architecture

- **Primary Classes / Headers:** `clsScreen.h`, `clsDeleteClientScreen.h`, `clsBankClient.h`
