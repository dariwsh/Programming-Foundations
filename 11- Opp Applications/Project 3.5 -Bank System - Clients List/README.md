# 🏦 Bank System — Lesson 05: Clients List Table

> **Milestone:** Project 3: Bank System — Lesson #05  
...
Loads all client records into a collection of `clsBankClient` objects and presents them in a formatted tabular layout.

---

## 🎯 Key Concepts & Implementation Highlights

- `clsBankClient::GetClientsList()` returning `vector<clsBankClient>`
- Formatted console output with headers, separators, and column alignments
- Read-only batch record retrieval from persistent storage
