# 👥 Bank System — Lesson 19: List Users Screen (`clsListUsersScreen`)

> **Milestone:** Project 3: Bank System — Lesson #19 (List Users Screen)  
...
Presents all registered bank staff members in a formatted table displaying their username, full name, phone, email, and permission values.

---

## 🎯 Key Concepts & Implementation Highlights

- `clsListUsersScreen::ShowUsersList()` implementation
- Tabular user list formatting
- Read-only query of all user objects

---

## 🗂️ Key Files & Architecture

- **Primary Classes / Headers:** `clsScreen.h`, `clsListUsersScreen.h`, `clsUser.h`
