...
int main()
{
	...
	cin >> totalSeconds; // √œŒ· 193535

	// 2. Õ”«» «·√Ì«„
	int days = totalSeconds / secondsInDay;
	int remainder = totalSeconds % secondsInDay; // «·»«ﬁÌ »⁄œ «” Œ—«Ã «·√Ì«„

	// 3. Õ”«» «·”«⁄«  „‰ «·„ »ﬁÌ (remainder) Ê·Ì” „‰ «·—ﬁ„ «·√’·Ì
	int hours = remainder / secondsInHour;
	remainder = remainder % secondsInHour;      // «·»«ﬁÌ »⁄œ «” Œ—«Ã «·”«⁄« 

	// 4. Õ”«» «·œﬁ«∆ﬁ „‰ «·„ »ﬁÌ «·ÃœÌœ
	int minutes = remainder / secondsInMinute;

	// 5. «·ÀÊ«‰Ì «·‰Â«∆Ì… ÂÌ „«  »ﬁÏ ›Ì «·‰Â«Ì…
