...
int main() {
    ...
    int bytes;
    int bits;
    cout << "Type Number Of Kilobytes: ";
    cin >> kilo_byte;
    cout << " The number of Kilobytes that user input is: " << kilo_byte * 1024<< " kilo byte \n" << endl;
    cout << " The number of Bytes is: " << kilo_byte * 1024 * 1024<< " byte \n" << endl;
    cout << " The number of Bits is: " << kilo_byte * 8 * 1024 * 1024<< " bit \n" << endl;
}
*/
